...
// Keep the complete history. The round number is derived from past rounds and
// must not stop advancing after an arbitrary display limit.
export const MAX_LOTTO_ROUNDS = 1000;
