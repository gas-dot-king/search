        ...
        <table>
          <thead>
            <tr>
              ...
              <th className="num" colSpan={2}>관리</th>
            </tr>
          </thead>
          <tbody>
            {users.map((user) => (
              <tr key={user.id}>
                <td>{user.nickname}</td>
                <td className="num">{user.filled}/16</td>
                <td className="num">{user.lines}</td>
                <td className="num">{user.lottoEntries}장</td>
                <td className="num">
